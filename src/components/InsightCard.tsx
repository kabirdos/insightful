...
export default function InsightCard({
  ...
  return (
    <Link
      href={`/insights/${slug}`}
      className="group block rounded-xl border border-slate-200 bg-white p-5 transition-all duration-200 hover:border-blue-200 hover:shadow-lg hover:shadow-blue-500/5 dark:border-slate-800 dark:bg-slate-900/50 dark:hover:border-blue-900 dark:hover:shadow-blue-500/10"
    >
      {/* Author Row */}
      ...
      {/* Title / Stats */}
      <h3 className="mt-3 text-base font-semibold text-slate-900 group-hover:text-blue-600 dark:text-slate-100 dark:group-hover:text-blue-400 line-clamp-2">
        {title}
      </h3>
